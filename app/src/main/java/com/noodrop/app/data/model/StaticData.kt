...
Expect gradual improvements over 4-8 weeks.""",
        ...
        Protocol(
            ...
            accent = ProtocolAccent.BLUE, status = ProtocolStatus.PAID, appProductId = "focus",
...
Most users report noticeable shifts by week 3.""",
        ...
        Protocol(
            ...
            accent = ProtocolAccent.ORANGE, status = ProtocolStatus.PAID, appProductId = "longevity",
